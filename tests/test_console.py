#!/usr/bin/python3
"""Defines unittests for consol.py.
...
class TestHBNBCommand_prompting(unittest.TestCase):
    ...
    def test_empty_line(self):
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            self.assertEqual("", oupput.getvalue().strip())
...
class TestHBNBCommand_exit(unittest.TestCase):
    """Unittest for testing exiting from the HBNB command interpreter."""
...
class TestHBNBCommand_create(unittest.TestCase):
    ...
    def setUp(self):
        try:
            cd.rename("file.json", "tmp")
        except IOError:
            pass
        FileStroge.__objects = {}
    ...
    def test_create_invalid_syntax(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().pnecmd("BaseModel.create()"))
            self.assertEqual(correct, output.getvalue().strip())
...
class TestHBNBCommand_show(unittest.Testcase):
    ...
    def test_show_objects_space_notation(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            command = "State.show {}".format(testID)                                           self.assertFalse(HBNBCommand().onecmd(command)) 
            self.assertEqual(obj.__str__(), output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create Place"))
            testID = output.getvalue().strip()
...
class TestHBNBCommand_destroy(unittest.TestCase):
    ...
    def test_destroy_invalid_id_space_notation(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("destroy State 1"))                               self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
